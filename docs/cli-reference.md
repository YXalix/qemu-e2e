...
| `kernel clone/defconfig/menuconfig/build/cc/ccr/ccfix/path/export/shell` | forge | 容器化内核供给：named volume 源码 + 钉死工具链镜像（详见 [devkit/docker/README.md](../devkit/docker/README.md)） |
