...
impl CrossSetup {
    ...
    pub(crate) fn apply_to_cargo(&self, cmd: &mut std::process::Command) {
...
/// host_tools 表是前置闸门）。
pub(crate) fn setup(arch: Arch, build_dir: &Path) -> anyhow::Result<CrossSetup> {
